...
import { StyleSheet, Text, View, Pressable, Animated, Easing, Dimensions, Platform } from 'react-native';
...
const Home = ({ navigation }) => {
  ...
  return (
    <LinearGradient colors={gradientColors} style={styles.screenGradient}>
      ...
      {/* This container uses flex: 1 to take up available vertical space, pushing buttons to bottom */}
      ...
      {/* --- Fixed Buttons Container (Always at the bottom) --- */}
      <View style={styles.fixedButtonContainer}>
        <Pressable style={styles.button} onPress={navigateToAlarmList}>
          <Text style={styles.buttonText}>Add Alarm</Text>
        </Pressable>
        <Pressable style={styles.button} onPress={navigateToTimer}>
...
const styles = StyleSheet.create({
  ...
  contentContainer: {
    ...
    paddingTop: 60, // Padding from the top of the screen
  },
  fixedButtonContainer: {
    ...
    paddingBottom: 40, // Padding at the very bottom of the screen
  },
  headerContainer: {
    alignItems: 'center',
    // No specific paddingTop here, as contentContainer handles overall top padding
  },
  headerText: {
    fontSize: 45,
    fontWeight: 'bold',
  ...
  timeContainer: {
    alignItems: 'center',
    marginTop: 10, // Space between header and time
  },
  timeText: {
    fontSize: 72,
    fontWeight: 'bold',
  ...
  button: {
    ...
    // Removed borderWidth and borderColor for a cleaner, solid look
    backgroundColor: '#3498DB', // A strong, vibrant blue for high visibility
    minWidth: 150,
    alignItems: 'center',
    shadowColor: '#000',
  ...
  buttonText: {
    color: '#FFFFFF', // Pure white text for maximum contrast on the blue button
    fontSize: 18,
    fontWeight: 'bold',
  },
  celestialBody: {
    ...
    height: 50,
    borderRadius: 25,
    // Shadow properties are now inline in the component style for dynamic adjustment based on `isNight`
    // Moved `shadowOpacity`, `shadowRadius`, and `elevation` directly into the component's style array
    zIndex: 2, // Ensures it's above glow and background elements
  },
  celestialGlow: {
    position: 'absolute',
    width: 50,
    height: 50,
    borderRadius: 25,
    zIndex: 1, // Ensures it's behind the celestial body but above background elements
  },
  cloud: {
    position: 'absolute',
    backgroundColor: 'rgba(255,255,255,0.8)',
    borderRadius: 20,
    // Optimized: Reduced shadow properties for better performance
    shadowColor: '#000',
