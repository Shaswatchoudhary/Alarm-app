...
// Create a function that returns the current color scheme
const getCurrentColorScheme = () => Appearance.getColorScheme();
...
export const toastConfig = {
  ...
  info: ({ text1, text2 }) =>
    ToastBox({
      ...
      iconColor: '#fff',
      bgColor: getCurrentColorScheme() === 'dark' ? '#444' : '#3A86FF',
      text1,
      text2,
    }),
};
